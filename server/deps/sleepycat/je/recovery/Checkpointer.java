...
public class Checkpointer extends DaemonThread implements EnvConfigObserver {
    ...
    public synchronized void doCheckpoint(CheckpointConfig config,
        ...
        try {
             ...
             * are equal to or after that LSN.
             *
             * The current value must be retrieved from TxnManager BEFORE
             * logging CkptStart, to ensure that all transactions in
             * progress will be replayed by recovery.  [#19346]
             */
             ...
             * is null, meaning that no txns are active.  This is the correct
             * boundary for replaying LNs during recovery and will be stored in
             * the CkptEnd entry.
             */
